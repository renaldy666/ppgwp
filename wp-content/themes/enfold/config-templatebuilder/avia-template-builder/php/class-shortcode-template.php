...
if ( ! class_exists( 'aviaShortcodeTemplate' ) )
{
	...
	abstract class aviaShortcodeTemplate extends aviaBuilder\base\object_properties
	{
		/**
		 *
		 * @var AviaBuilder
		...
		*/
		...
		protected function element_styles_defaults( array $args )
		{
			...
			if( '' == $return['element_id'] )
			{
				$return['element_id'] = $this->unique_css_element_id( $args['atts'], $args['shortcodename'] );
			}

			if( ! $return['element_styling'] instanceof aviaElementStyling )
			{
		 ...
		 * @return array
		 */
		public function get_element_styles_query_item( array $args )
		{
			return $this->element_styles_defaults( $args );
		}
