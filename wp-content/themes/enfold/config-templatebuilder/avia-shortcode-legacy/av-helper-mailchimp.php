 ...
 * Can be used in addition to class av_mailchimp_api. Kept to allow backwards compatibility.
 *
 * Use action 'ava_builder_core_files_loaded' or 'ava_builder_shortcode_files_loaded' to load if needed.
 *
 *
 * @since 4.8.9		class av_mailchimp_api renamed to av_mailchimp_api_old (code based on version 4.8.9)
 * @deprecated since 4.8.9
 */
if( ! defined( 'ABSPATH' ) ) {  exit;  }    // Exit if accessed directly


if( ! class_exists( 'av_mailchimp_api_old' ) )
{
	/**
	 * @deprecated since 4.8.9
	 */
	class av_mailchimp_api_old
	{
