	...
	class avia_sc_events_countdown extends aviaShortcodeTemplate
	{
				...
				array(
					...
					array(
							...
							'templates_include'	=> array(
													$this->popup_key( 'content_event' ),
													$this->popup_key( 'content_countdown' )
		...
		protected function register_dynamic_templates()
		{
			...
			$template = array(
							array(
								'type'			=> 'template',
								'template_id'	=> 'toggle',
								'title'			=> __( 'Events', 'avia_framework' ),
								'content'		=> $c
							),
					);

			AviaPopupTemplates()->register_dynamic_template( $this->popup_key( 'content_event' ), $template );
			...
			$template = array(
							array(
								'type'			=> 'template',
								'template_id'	=> 'toggle',
								'title'			=> __( 'Countdown', 'avia_framework' ),
								'content'		=> $c
							),
					);


			AviaPopupTemplates()->register_dynamic_template( $this->popup_key( 'content_countdown' ), $template );
			...
			$c = array(
						array(
							...
							'id_sizes'		=> array(
												...
												'desktop'	=> 'av-desktop-font-size-headline',
		...
		protected function get_element_styles( array $args )
		{
			...
			$default = array(
						...
						'heading_tag'			=> '',
						'heading_class'			=> '',
						'add_container_class'	=> 'av-events-countdown'
					);
