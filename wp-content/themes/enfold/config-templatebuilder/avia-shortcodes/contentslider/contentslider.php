...
if ( ! class_exists( 'avia_sc_content_slider' ) )
{
	class avia_sc_content_slider extends aviaShortcodeTemplate
	{
		...
		protected function extra_assets()
		{
			...
			wp_enqueue_style( 'avia-module-slideshow-contentpartner', AviaBuilder::$path['pluginUrlRoot'] . "avia-shortcodes/contentslider/contentslider{$min_css}.css", array( 'avia-module-slideshow' ), $ver );
