...
if( ! class_exists( 'avia_sc_notification' ) )
{
	class avia_sc_notification extends aviaShortcodeTemplate
	{
		...
		protected function extra_assets()
		{
			...
			//load css
			wp_enqueue_style( 'avia-module-notification', AviaBuilder::$path['pluginUrlRoot'] . "avia-shortcodes/notification/notification{$min_css}.css", array( 'avia-layout' ), $ver );

			//load js
			wp_enqueue_script( 'avia-module-notification', AviaBuilder::$path['pluginUrlRoot'] . "avia-shortcodes/notification/notification{$min_js}.js", array( 'avia-shortcodes' ), $ver, true );
		}
