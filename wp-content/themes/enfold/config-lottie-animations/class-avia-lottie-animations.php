...
if( ! class_exists( 'avia_LottieAnimations' ) )
{
...
//			$min_css = avia_minify_extension( 'css' );
			...
			wp_register_script( 'avia-dotlottie-script', AVIA_BASE_URL . "config-lottie-animations/assets/lottie-player/dotlottie-player{$min_js}.js", [], $version );
