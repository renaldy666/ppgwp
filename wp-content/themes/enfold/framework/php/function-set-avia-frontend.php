...
if( ! function_exists( 'avia_is_dynamic_template' ) )
{
	...
	{
		_deprecated_function( 'avia_is_dynamic_template', '4.9', 'not needed in Enfold' );
...
if( ! function_exists( 'avia_get_option_set' ) )
{
	...
	{
		_deprecated_function( 'avia_get_option_set', '4.9', 'check, that function is not needed ???');
...
if( ! function_exists( 'avia_check_custom_widget' ) )
{
	...
	{
		_deprecated_function( 'avia_check_custom_widget', '4.9', 'unused - will be removed in future');
